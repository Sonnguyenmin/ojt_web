  ...
  return (
    <>
      <div className="job-info-content">
        <h2 className="text-[24px] font-semibold leading-[32p] gap-3 bg-[rgba(45_44_44_1)] flex items-center my-[32px] mx-[24px] max-md:mx-[12px] max-sm:mx-[12px]">
          <i className="text-[16px] fa-solid fa-chevron-left max-md:hidden max-sm:hidden"></i>
          Chỉnh sửa tin tuyển dụng
        </h2>
        <form action="">
          <div className="bg-[#fff] m-[24px] max-w-[100%] rounded-[6px] pb-8 max-md:mx-0 max-md:max-w-[calc(100%-12px)] max-sm:mx-0 max-sm:max-w-[calc(100%-12px)]">
            <div className="flex items-center p-[24px] text-[16px] gap-2 text-[#171717] leading-6  border-b border-solid border-[#ddd] max-md:px-3 max-sm:px-3">
            ...
            <div className="mx-[80px] mt-6  max-md:m-[0_auto]  max-sm:m-[0_auto] max-md:max-w-[calc(100%-12px)] max-sm:max-w-[calc(100%-12px)]">
          ...
          <div className="bg-[#fff] m-[24px] max-w-[100%] rounded-[6px] p-6 flex items-center justify-between">
          ...
          <div className="flex items-center justify-end gap-3 m-[24px_24px_48px_24px] max-w-[100%] rounded-[6px] p-6">
            <button className="w-[160px] h-[48px] rounded-[8px] bg-[rgba(221,221,221,1)] shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)] font-semibold text-[#171717] text-[16px] leading-6">
              Hủy
            </button>
            <button className="w-[210px] h-[48px] rounded-[8px] bg-[rgb(171,31,36)] shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)] text-[16px] text-[#fff] font-semibold">
              Cập nhật
            </button>
          </div>
        </form>
